...
export const SPECS = {
  ...
  gto: {
    ...
    roof: [[0.00, 0.62], [0.08, 0.50], [0.17, 0.44], [0.26, 0.41], [0.34, 0.39], 
           [0.42, 0.34], [0.50, 0.14], [0.58, 0.06], [0.66, 0.07], [0.74, 0.18], 
           [0.84, 0.30], [0.93, 0.34], [1.00, 0.36]],
    glass: {cowl: 0.44, roofF: 0.56, roofR: 0.68, deck: 0.78, base: 0.42, inset: 0.03, surround: "chrome", pillarW: 5, vent: true, dripRail: true},    doors: [0.44, 0.62], creaseY: 0.52, archLift: 1.12, flareMm: 24, endLift: 0.36,
  ...
  f40: {
    ...
    roof: [[0.00, 0.72], [0.11, 0.60], [0.22, 0.51], [0.32, 0.45], [0.40, 0.28], 
           [0.48, 0.10], [0.56, 0.05], [0.66, 0.10], [0.78, 0.24], [0.90, 0.30], 
           [1.00, 0.34]],
    glass: {cowl: 0.4, roofF: 0.5, roofR: 0.62, deck: 0.7, base: 0.34, inset: 0.02, surround: "black", pillarW: 5},    doors: [0.37, 0.56], creaseY: 0.44, archLift: 1.12, flareMm: 26, endLift: 0.30,
