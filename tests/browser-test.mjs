...
const CAR_KEYS = ["pagani", "bugatti", "mclaren", "ferrari", "koenigsegg", "tesla", "amg", "aston", "gto", "revuelto", "porsche918", "taycan", "supra", "f1mercedes", "f1redbull", "f1ferrari", "f1mclaren", "f1aston", "f1alpine", "f1williams", "f1racingbulls", "f1haas", "f1audi", "f1cadillac", "dacia", "fordraptor", "grhilux", "hunter"];
...
console.log("▶ garage");
check("twenty-eight car cards render", await page.locator(".car-card").count() === 28);
